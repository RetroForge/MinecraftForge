...
{
    public static final int READ_TIMEOUT = Integer.getInteger("fml.readTimeout",30);
    public static final int LOGIN_TIMEOUT = Integer.getInteger("fml.loginTimeout",600);
